  ...
  return (
    <div className={styles.aboutEvent}>
      <div className={styles.breadCrums}>
        ...
        <a className={styles.eventA} href="events">
          Мероприятия
        </a>
        <img className={styles.arrow} src="arrow.svg" alt="" />
        <a className={styles.eventA2} href="aboutevent">
          О мероприяти
        </a>
      </div>
      ...
      <div className={styles.whatAwait}>
        ...
        <div className={styles.ul}>
          <div className={styles.li}>
            <img src="li.svg" alt="" />
            <text className={styles.liText}>
              «Вызовы города»: команды стажёров вместе с
              капитанами-разработчиками будут решать <br></br> задачи от
              бизнес-групп Екома и Райдтех в игровой форме.
            </text>
          </div>
          <div className={styles.li}>
            <img src="li.svg" alt="" />
      ...
      <div className={styles.place}>
        ...
        <div className={styles.org}>
          ...
          <div className={styles.orgInfo}>
            <text className={styles.orgInfoName}>
              Фамилия <br></br> Имя
            </text>
            <text className={styles.orgInfo}>
              {" "}
              Должность, стаж, степень, звание <br />
            </text>
            <text className={styles.orgInfo}>
              {" "}
